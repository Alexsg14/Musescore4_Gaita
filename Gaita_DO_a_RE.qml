...
MuseScore {
    title: "Gaita — DO → RE"
    version: "0.1.0"
    description: "Convierte notación de gaita del sistema DO al sistema RE moviendo cada cabeza una posición diatónica, sin transposición cromática normal."
    menuPath: "Plugins.Gaita.DO → RE"
    ...
    function runConversion() {
        ...
        console.log("Gaita DO→RE: " + totalChanged +
